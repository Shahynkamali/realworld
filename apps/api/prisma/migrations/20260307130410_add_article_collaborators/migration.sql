/*
  ...
  - You are about to drop the column `demo` on the `User` table. All the data in the column will be lost.
...
CREATE TABLE "ArticleCollaborator" (
    ...
    CONSTRAINT "ArticleCollaborator_invitedById_fkey" FOREIGN KEY ("invitedById") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
